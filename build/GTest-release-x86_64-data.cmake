...
########### VARIABLES #######################################################################
#############################################################################################
set(gtest_PACKAGE_FOLDER_RELEASE "/home/eoguz/.conan/data/gtest/cci.20210126/_/_/package/71c983c52942eb4756e4bd60e4cbec9fd7557e5d")
set(gtest_INCLUDE_DIRS_RELEASE "${gtest_PACKAGE_FOLDER_RELEASE}/include")
set(gtest_RES_DIRS_RELEASE "${gtest_PACKAGE_FOLDER_RELEASE}/res")
...
set(gtest_SYSTEM_LIBS_RELEASE pthread)
set(gtest_FRAMEWORK_DIRS_RELEASE "${gtest_PACKAGE_FOLDER_RELEASE}/Frameworks")
set(gtest_FRAMEWORKS_RELEASE )
set(gtest_BUILD_MODULES_PATHS_RELEASE )
set(gtest_BUILD_DIRS_RELEASE "${gtest_PACKAGE_FOLDER_RELEASE}/")
...
set(gtest_GTest_gmock_main_RES_DIRS_RELEASE "${gtest_PACKAGE_FOLDER_RELEASE}/res")
...
set(gtest_GTest_gmock_main_FRAMEWORK_DIRS_RELEASE "${gtest_PACKAGE_FOLDER_RELEASE}/Frameworks")
...
list(APPEND gtest_BUILD_MODULES_PATHS_RELEASE )
...
set(gtest_GTest_gmock_RES_DIRS_RELEASE "${gtest_PACKAGE_FOLDER_RELEASE}/res")
...
set(gtest_GTest_gmock_FRAMEWORK_DIRS_RELEASE "${gtest_PACKAGE_FOLDER_RELEASE}/Frameworks")
...
set(gtest_GTest_gtest_main_RES_DIRS_RELEASE "${gtest_PACKAGE_FOLDER_RELEASE}/res")
...
set(gtest_GTest_gtest_main_FRAMEWORK_DIRS_RELEASE "${gtest_PACKAGE_FOLDER_RELEASE}/Frameworks")
...
set(gtest_GTest_gtest_RES_DIRS_RELEASE "${gtest_PACKAGE_FOLDER_RELEASE}/res")
...
set(gtest_GTest_gtest_SYSTEM_LIBS_RELEASE pthread)
set(gtest_GTest_gtest_FRAMEWORK_DIRS_RELEASE "${gtest_PACKAGE_FOLDER_RELEASE}/Frameworks")
